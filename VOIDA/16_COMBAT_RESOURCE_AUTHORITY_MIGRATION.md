...
## SOURCE:
Current Roblox combat/resource modules plus `VoidHunterComponents.Types` definitions for `ShieldGenerator`, `ShieldDish`, `Reactor`, and `PowerPlant`. Raw-source numerical parity remains subject to the raw forensic authority rules.
...
## TEST:
- All three modified combat/resource files were replaced as complete UTF-8 files and re-read from GitHub.
